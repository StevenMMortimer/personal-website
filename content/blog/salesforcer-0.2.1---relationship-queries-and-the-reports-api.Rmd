---
title: salesforcer 0.2.1 - Relationship Queries and the Reports API
author: Steven M. Mortimer
date: '2020-08-28T12:15:21Z'
slug: salesforcer-0.2.1---relationship-queries-and-the-reports-api
categories:
  - R
tags:
  - r-code
  ...
  - CRAN
  - CRM
description: "The latest CRAN release of the salesforcer package (0.2.1) has enhanced support for complex relationship queries and functions to execute and manage reports in your Salesforce Org."
image: "blog/salesforcer-0.2.1---relationship-queries-and-the-reports-api/salesforcer-logo.png"
output:
  blogdown::html_page
draft: true
---

<img src="/blog/salesforcer-0.2.1---relationship-queries-and-the-reports-api/salesforcer-logo.png" style="display:block;margin:auto;max-height:300px;" />

The latest version of the {salesforcer} package (v0.2.1) is now available on CRAN 
...
site for {salesforcer} here: <a target="_blank" href="https://stevenmmortimer.github.io/salesforcer/news/index.html#salesforcer-0-2-1-release">https://stevenmmortimer.github.io/salesforcer/news/index.html#salesforcer-0-2-1-release</a>.
...
<img src="/blog/salesforcer-0.2.1---relationship-queries-and-the-reports-api/report-screenshot.png" style="display:block;margin:auto;max-height:500px;" />
...
Bulk 1.0 query functionality. In {salesforcer} 0.2.1 the default API when using
...
One upgrade for {salesforcer} v0.2.1 is better support for relationship queries, 
...
For a complete listing of all changes made in the 0.2.1 release of {salesforcer} please 
