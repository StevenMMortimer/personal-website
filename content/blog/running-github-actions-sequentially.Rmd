...
**TL;DR**: If you need sequential execution in GitHub Actions consider these solutions: 
  ...
  - <b>Sequential <u>jobs</u></b>: Set `max-parallel: 1` within the <a target="_blank" href="https://docs.github.com/en/actions/reference/workflow-syntax-for-github-actions#jobsjob_idstrategymax-parallel"><code><u>jobs.strategy</u></code></a> element of the workflow.
...
href="https://docs.github.com/en/actions/reference/workflow-syntax-for-github-actions#jobsjob_idstrategymax-parallel"><code><u>jobs.strategy</u></code></a>
...
and `sha` <b><u>and</u></b> the latest run does not have a 'completed' status.
